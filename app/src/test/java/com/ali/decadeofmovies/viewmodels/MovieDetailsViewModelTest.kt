package com.ali.decadeofmovies.viewmodels

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import androidx.lifecycle.Observer
import com.ali.decadeofmovies.models.Image
import com.ali.decadeofmovies.repositories.IMovieRepository
import com.ali.decadeofmovies.repositories.remote.models.response.GetImagesResponse
import com.ali.decadeofmovies.repositories.remote.models.response.Images
import com.ali.decadeofmovies.rxjava.TestSchedulerProviderImpl
        ...
        `when`(moviesRepo.getImagesFromFlickr(anyString(), anyInt(), anyInt()))
            .thenReturn(
                Observable.just(
                    GetImagesResponse(
                        1,
                        Images(mutableListOf(Image("0", "337c2dd0487f7ded", "0", 0)))
                    )
                )
            )
        viewModel.loadFlickerImages("")
